...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        predict_labels = [obj.label for obj in predict_examples]
        predict_text = [obj.text_a for obj in predict_examples]
        ...
        with tf.gfile.GFile(output_predict_file, "w") as writer:
            ...
            for (i, prediction) in enumerate(result):
                ...
                if i >= num_actual_predict_examples:
                    break
                output_line = "\t".join(str(class_probability) for class_probability in probabilities) + '\t' + predict_labels[i] + '\t' + predict_text[i] + "\n"
